...
# product_name: None
# product_quantity: 0
# event_name_downcased: enter_clinic


class EnterClinic(SuppliedIntervention):
    def distribute_event(self, uptakers: ss.uids, product_name: str, product_quantity_per_agent: int):
        # apply the effect of "enter clinic" to the uptakers, modifying their state
    ...
    def step(self):
        ...
        self.parent.enter_clinic_selected = event_selected
        self.parent.enter_clinic_results = event_results
        return
        # End template.
