...
class TakeHivTest(SuppliedIntervention):
    def distribute_event(self, uptakers: ss.uids, product_name: str, product_quantity_per_agent: int):
        # apply the effect of "take hiv test" to the uptakers, modifying their state
    ...
    def step(self):
        ...
        self.parent.take_hiv_test_selected = event_selected
        self.parent.take_hiv_test_results = event_results
        return
        # End template.
