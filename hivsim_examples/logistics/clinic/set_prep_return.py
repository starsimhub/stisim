...
class SetPrepReturn(SuppliedIntervention):
    def distribute_event(self, uptakers: ss.uids, product_name: str, product_quantity_per_agent: int):
        # apply the effect of "set prep return" to the uptakers, modifying their state
    ...
    def step(self):
        ...
        self.parent.set_prep_return_selected = event_selected
        self.parent.set_prep_return_results = event_results
        return
        # End template.
