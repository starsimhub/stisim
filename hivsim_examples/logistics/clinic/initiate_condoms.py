...
class InitiateCondoms(SuppliedIntervention):
    def distribute_event(self, uptakers: ss.uids, product_name: str, product_quantity_per_agent: int):
        # apply the effect of "initiate condoms" to the uptakers, modifying their state
        ...
        # Both are derived from the 'Supplies' dict key of the event, e.g.: 'Supplies': {'condoms': 25}
    ...
    def step(self):
        ...
        # From the 'Supplies' dict key of the event, e.g.: 'Supplies': {'condoms': 25}
        product_name = 'condoms'
        product_quantity_per_agent = 25
        ...
        self.parent.initiate_condoms_selected = event_selected
        self.parent.initiate_condoms_results = event_results
        return
        # End template.
