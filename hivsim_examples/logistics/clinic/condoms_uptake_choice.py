...
class CondomsUptakeChoice(SuppliedIntervention):
    def distribute_event(self, uptakers: ss.uids, product_name: str, product_quantity_per_agent: int):
        # apply the effect of "condoms uptake choice" to the uptakers, modifying their state
    ...
    def step(self):
        ...
        self.parent.condoms_uptake_choice_selected = event_selected
        self.parent.condoms_uptake_choice_results = event_results
        return
        # End template.
