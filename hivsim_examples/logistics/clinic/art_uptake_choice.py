...
class ArtUptakeChoice(SuppliedIntervention):
    def distribute_event(self, uptakers: ss.uids, product_name: str, product_quantity_per_agent: int):
        # apply the effect of "art uptake choice" to the uptakers, modifying their state
    ...
    def step(self):
        ...
        self.parent.art_uptake_choice_selected = event_selected
        self.parent.art_uptake_choice_results = event_results
        return
        # End template.
